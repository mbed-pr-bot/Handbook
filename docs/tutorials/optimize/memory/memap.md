...
**memap** is a simple utility that displays static memory information required by <a href="https://github.com/mbedmicro/mbed" target="_blank">Arm Mbed</a> applications. This information is produced by analyzing the memory map file previously generated by your toolchain.
...
If you are experiencing problems, or would like additional features, please raise a ticket on <a href="https://github.com/mbedmicro/mbed/issues" target="_blank">GitHub</a> and use `[memap] ` in the title.
