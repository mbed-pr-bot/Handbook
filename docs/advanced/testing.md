...
You can build tests through mbed CLI. For information on using mbed CLI, please see its [documentation](https://docs.mbed.com/docs/mbed-os-handbook/en/5.3/dev_tools/cli/).
...
You can run automated tests through mbed CLI. For information on using mbed CLI, please see its [documentation](https://docs.mbed.com/docs/mbed-os-handbook/en/5.3/dev_tools/cli/).
